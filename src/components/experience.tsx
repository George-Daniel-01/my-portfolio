...
const Experience = () => {
  return (
    <section id="experience" className="relative pt-32 overflow-hidden">
                ...
                >
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 my-4">
                      <p className="text-[#6f1cd7] font-medium tracking-wide">{exp.company}</p>
                      <div className="flex items-center gap-4">
                        <span className="hidden md:inline text-[#FFFFFF40]">•</span>
                        <span className="text-[#FFFFFF99] text-sm">{exp.location}</span>
                        <span className="hidden md:inline text-[#FFFFFF40]">•</span>
                        <span className="text-[#FFFFFF99] text-sm">{exp.period}</span>
                      </div>
                    </div>
