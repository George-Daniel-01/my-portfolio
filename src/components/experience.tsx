          ...
          <div className="space-y-12">
            {[

              {
                ...
                period: "2024 - Present",
                description: [
            "Developing backend infrastructure for a personal event management application.",
    "Designing and implementing APIs for event booking and management features.",
    "Practicing database optimization techniques to handle simulated high-volume ticket sales."
                ]
              }
