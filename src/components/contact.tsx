  ...
  return (
    <section className="mx-[30px] lg:mx-[76px] lg:mt-[150px]">
      <div className="flex flex-col items-center gap-[35px] md:gap-[25px]">
        ...
        >
        Whether it’s starting something new or improving what you already have, I can help bring your ideas to life.
        </h3>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-[10px]">
          ...
          >
            {timeOfDay === "morning" && <span>Building apps⚡</span>}
            {timeOfDay === "afternoon" && <span>localhost:3000</span>}
            {timeOfDay === "evening" && <span>192.168.137.1:3000</span>}
