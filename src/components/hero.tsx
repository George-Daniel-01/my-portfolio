  ...
  return (
    <>
      <section className="mx-auto px-[38px] pt-[100px] md:px-[26px] lg:pt-[120px] lg:pl-[80px] lg:pr-[40px]">
        ...
        I&#39;m Daniel, a self-taught full-stack developer currently sharpening my skills at the NIT Center in Agbara, Nigeria. Since 2024, I’ve been building projects in web and app development
              </p>
...
{/*               <motion.a
              ...
              <motion.a
                href="https://www.instagram.com/georgeabiamakadaniel2/?__pwa=1"
                target="_blank"
                rel="noreferrer"
                whileTap={{ scale: 1.1 }}
                whileHover={{ scale: 0.99 }}
